            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-primary">
                        <form role="form" class="form-horizontal" method="POST" action="modules/user/proces.php?act=insert" enctype="multipart/form-data">
                            <div class="box-body">
    ...
    elseif($_GET['form']=='edit'){
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-primary">
                        <form role="form" class="form-horizontal" method="POST" action="modules/user/proces.php?act=update" enctype="multipart/form-data">
                            <div class="box-body">
