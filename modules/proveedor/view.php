                        ...
                        <tbody>
                            <?php
                                ...
                                while($data = mysqli_fetch_assoc($query)){
                                    ...
                                    href="modules/proveedor/proces.php?act=delete&cod_proveedor=<?php echo $data['cod_proveedor'];?>"
                                    onclick="return confirm('¿Estás seguro de eliminar <?php echo $data['razon_social'];?>?')">
