...
<li class="Dropdown user user-menu">
    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
        <?php 
            if($data['foto']==""){ ?>
                <img src="images/user/user-default.png" class="user-image" alt="imagen del usuario">
           <?php } 
           else{?>
           <img src="images/user/<?php echo $data['foto']; ?>" class="user-image" alt="imagen del usuario">
            <?php 
            }
        ?>
    ...
    <ul class="dropdown-menu">
        <li class="user-header">
            <?php 
                if($data['foto']==""){ ?>
                    <img src="images/user/user-default.png" class="img-circle" alt="imagen del usuario">
            <?php } 
            else{?>
            <img src="images/user/<?php echo $data['foto']; ?>" class="img-circle" alt="imagen del usuario">
            <?php 
                }
            ?>
            <p>
